...
namespace AIEJumpyMan
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            AIE.StateManager.CreateState("LOADING1", new SplashState());
            AIE.StateManager.CreateState("LOADING2", new SplashState());
            AIE.StateManager.CreateState("MAINMENU", new MainMenuState());
            AIE.StateManager.CreateState("LEVELSELECT", new MainMenuState());
            ...
            AIE.StateManager.CreateState("LEVELCOMPLETE2", new LevelCompleteState());
            AIE.StateManager.CreateState("GAMEOVER", new GameOverState());
            AIE.StateManager.CreateState("GAMEOVER2", new GameOverState());
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if ("LOADING1" == AIE.StateManager.StateStackCurrent)
            {
                Reset();
            }

            if ("LOADING2" == AIE.StateManager.StateStackCurrent)
            {
                LoadLevel2();
            }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            else if ("LEVEL2" == AIE.StateManager.StateStackCurrent)
            {
                if (lives > 0)
                {
                    spriteBatch.Begin(transformMatrix: transformMatrix);
                ...
                {
                    LoadLevel2();
                    AIE.StateManager.PushState("GAMEOVER2");
                }
            }
        ...
        private void CheckCollisions()
        {
            ...
            if (IsColliding(player.Bounds, goal.Bounds) == true)
            {
                ...
                {
                    AIE.StateManager.PushState("LEVELCOMPLETE2");
                }
